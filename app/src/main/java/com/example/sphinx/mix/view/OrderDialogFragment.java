...
import com.example.sphinx.mix.databinding.FragmentOrderFormBinding;
import com.example.sphinx.mix.databinding.ItemVsStep1Binding;
import com.example.sphinx.mix.databinding.ItemVsStep2Binding;
import com.example.sphinx.mix.databinding.LayoutOrderConfirmationBinding;
...
public class OrderDialogFragment extends BottomSheetDialogFragment {
    ...
    private void initOrderStepOneView(ItemVsStep1Binding layoutStep1) {
        binding.btnGo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                binding.txtLabelColour.setText("Time");
                binding.txtLabelSize.setText("Date");
    ...
    private void initOrderStepTwoView(ItemVsStep2Binding step2Binding) {
        binding.btnGo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    @NonNull
    private Runnable onEnterConfirmScene(final LayoutOrderConfirmationBinding confirmationBinding) {
